...
/**
 * Fault class for {@link RedisDropConnectionFaultSpec}.
 *
 * @author kumargautam
 */
@SupportedEndpoints(endPoints = { EndpointType.REDIS_FI_PROXY })
public class RedisDropConnectionFault extends AbstractFault {

    public RedisDropConnectionFault(CommandExecutionFaultSpec faultSpec) throws MangleException {
        super(faultSpec, TaskType.INJECTION);
    }

    @Override
    public Map<String, String> getFaultSpecificArgs() {
        RedisDropConnectionFaultSpec redisFaultSpec = (RedisDropConnectionFaultSpec) faultSpec;
