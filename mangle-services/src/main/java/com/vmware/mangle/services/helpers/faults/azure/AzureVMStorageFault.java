 ...
 * @author bkaranam
 *
 *         Azure virtual machine Storage fault operations
 */

@SupportedEndpoints(endPoints = { EndpointType.AZURE })
public class AzureVMStorageFault extends AbstractFault {

    public AzureVMStorageFault(AzureVMStorageFaultSpec faultSpec) throws MangleException {
    ...
    protected Map<String, String> getFaultSpecificArgs() {
        AzureVMStorageFaultSpec localFaultSpec = (AzureVMStorageFaultSpec) faultSpec;
        Map<String, String> specificArgs = new HashMap<>();
        specificArgs.put("--selectRandomDisks", String.valueOf(localFaultSpec.getSelectRandomDisks()));
        return specificArgs;
    }
}
