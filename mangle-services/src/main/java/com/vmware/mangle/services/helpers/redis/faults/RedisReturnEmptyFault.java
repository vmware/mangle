...
/**
 * Fault class for {@link RedisFaultSpec}.
 *
 * @author kumargautam
 */
@SupportedEndpoints(endPoints = { EndpointType.REDIS_FI_PROXY })
public class RedisReturnEmptyFault extends AbstractFault {

    public RedisReturnEmptyFault(CommandExecutionFaultSpec faultSpec) throws MangleException {
        super(faultSpec, TaskType.INJECTION);
    }

    @Override
    public Map<String, String> getFaultSpecificArgs() {
        RedisFaultSpec redisFaultSpec = (RedisFaultSpec) faultSpec;
