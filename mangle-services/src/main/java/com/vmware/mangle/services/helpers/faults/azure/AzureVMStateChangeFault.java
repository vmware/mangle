 ...
 * @author bkaranam
 *
 *         Azure virtual machine state change fault operations
 */

@SupportedEndpoints(endPoints = { EndpointType.AZURE })
public class AzureVMStateChangeFault extends AbstractFault {

    public AzureVMStateChangeFault(AzureVMStateFaultSpec faultSpec) throws MangleException {
