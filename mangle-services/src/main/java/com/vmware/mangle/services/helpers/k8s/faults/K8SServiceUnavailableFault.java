 ...
 * @author bkaranam
 *
 *         Simulate service unavailable fault on kubernetes cluster
 */
@SupportedEndpoints(endPoints = { EndpointType.K8S_CLUSTER })
@SupportedResourceTypes(resourceTypes = { K8SResource.SERVICE })
public class K8SServiceUnavailableFault extends AbstractK8SSpecificFault {

    public K8SServiceUnavailableFault(K8SFaultSpec k8SFaultSpec) throws MangleException {
        super(k8SFaultSpec);
    }
