...
public class UserService {
	 ...
	 *
	 * @param session Provide Session Info
	...
	/**
	 * Funciton to create HashMap where Users as key and List of Sessions Used by
	 * that user as values
	 *
	 * @return hashMap
	 *
	...
	public HashMap<String, List<SessionInformation>> allUserToSessionsMapping() {
		HashMap<String, List<SessionInformation>> usersToSessionsMapping = new HashMap<String, List<SessionInformation>>();
