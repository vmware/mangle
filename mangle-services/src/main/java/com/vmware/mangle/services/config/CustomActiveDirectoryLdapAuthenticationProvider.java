...
public class CustomActiveDirectoryLdapAuthenticationProvider extends AbstractLdapAuthenticationProvider {
	 ...
	 * @param privilegeService the root DN (may be null or empty)
	 */
	...
	public boolean testConnection() {
		UsernamePasswordAuthenticationToken authToken = new UsernamePasswordAuthenticationToken(TEST_USER,
