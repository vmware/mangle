...
/**
 * Fault class for {@link RedisReturnErrorFaultSpec}.
 *
 * @author kumargautam
 */
@SupportedEndpoints(endPoints = { EndpointType.REDIS_FI_PROXY })
public class RedisReturnErrorFault extends AbstractFault {

    public RedisReturnErrorFault(CommandExecutionFaultSpec faultSpec) throws MangleException {
        super(faultSpec, TaskType.INJECTION);
    }

    @Override
    public Map<String, String> getFaultSpecificArgs() {
        RedisReturnErrorFaultSpec redisFaultSpec = (RedisReturnErrorFaultSpec) faultSpec;
