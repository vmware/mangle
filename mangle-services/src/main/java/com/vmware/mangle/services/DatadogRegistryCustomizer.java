...
/**
 * Class will customise the commons tags to datadog meter registry. It will be taken from the added
 * datadog metric provider to database.
 *
 * @author ashrimali
 *
 */
...
public class DatadogRegistryCustomizer implements MeterRegistryCustomizer<DatadogMeterRegistry> {
     ...
     */
    @Override
    public void customize(DatadogMeterRegistry registry) {
