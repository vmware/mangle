 ...
 * @author bkaranam
 *
 *         AWS EC2 Network fault operations
 */

@SupportedEndpoints(endPoints = { EndpointType.AWS })
public class AwsEC2NetworkFault extends AbstractFault {

    public AwsEC2NetworkFault(AwsEC2NetworkFaultSpec faultSpec) throws MangleException {
