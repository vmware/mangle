...
public class DbTransactionLatencyFault extends AbstractFault {

    public DbTransactionLatencyFault(DbTransactionLatencyFaultSpec faultSpec) throws MangleException {
    ...
    public Map<String, String> getFaultSpecificArgs() {
        DbTransactionLatencyFaultSpec transactionLatencyFaultSpec = (DbTransactionLatencyFaultSpec) faultSpec;
        ...
        specificArgs.put(FaultConstants.DB_TABLE_NAME_ARG, transactionLatencyFaultSpec.getTableName());
        specificArgs.put(FaultConstants.DB_LATENCY_ARG, String.valueOf(transactionLatencyFaultSpec.getLatency()));
        specificArgs.put(FaultConstants.DB_PERCENTAGE_ARG, String.valueOf(transactionLatencyFaultSpec.getPercentage()));
        return specificArgs;
    }
}
