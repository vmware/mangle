...
public class EntityCreatedEventTest {
    ...
    public void init() {
        ...
        eventMesage =
                "Created entity: " + endpointspec.getClass().getName() + " With Id: " + endpointspec.getPrimaryKey();
    }
    ...
    public void lombokShouldSetCorrectly() {
        ...
        Assert.assertEquals(getField(event, "name"), "EntityCreatedEvent");
    ...
    public void lombokShouldGetCorrectly() {
        ...
        Assert.assertEquals(event.getName(), "EntityCreatedEvent");
    ...
    public void eventsShouldNotBeEqualWithTheSameIdButDifferentNames() {
        EntityCreatedEvent event3 =
                new EntityCreatedEvent(endpointspec.getPrimaryKey(), endpointspec.getClass().getName());
        EntityCreatedEvent event4 =
                new EntityCreatedEvent(endpointspec.getPrimaryKey(), endpointspec.getClass().getName());
        event4.setName("EntityCreatedEventModified");
    ...
    @Test
    public void testEntityCreatedEventResolvableType() {
        EntityCreatedEvent event =
                new EntityCreatedEvent(endpointspec.getPrimaryKey(), endpointspec.getClass().getName());
        event.getResolvableType();
        Assert.assertEquals(event.getResolvableType().toString(), EntityCreatedEvent.class.getName());
    }
}
