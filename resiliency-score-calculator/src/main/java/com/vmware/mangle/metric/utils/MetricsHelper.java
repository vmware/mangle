...
public class MetricsHelper {
     ...
     */
    public static Boolean isEmptyTag(HashMap<String, String> tags) {
    ...
    public static Long getCurrentTimeStampInMillis() {
        ...
        log.trace("Returning the current timestamp in Millis : " + timeStampInMillis);
    ...
    public static HashMap<String, String> stringToHashMap(String tags) {
