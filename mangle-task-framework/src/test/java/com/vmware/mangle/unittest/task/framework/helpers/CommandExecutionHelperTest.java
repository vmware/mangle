 ...
 */
@Log4j2
public class CommandExecutionHelperTest {
    ...
    public void testRunCommands() {
        ...
        FaultTask<CommandExecutionFaultSpec> task =
                taskHelper.init(new CommandExecutionFaultSpec(), null);
    ...
    public void testRunCommandsWithCommandExecutionFailureOnOutput() throws MangleException {
        ...
        try {
            ...
            Assert.assertEquals(e.getErrorCode(), ErrorCode.COMMAND_EXEC_ERROR);
