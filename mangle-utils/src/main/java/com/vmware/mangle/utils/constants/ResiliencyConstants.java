...
public class ResiliencyConstants {
    ...
    public static final String RESILIENCY_SCORE_SUCCESS_MESSAGE = " Calculating Resiliency Score was successful. ";
    ...
    public static final int DEFAULT_METRIC_FLUSH_INTERVAL_IN_SECOND = 600;
