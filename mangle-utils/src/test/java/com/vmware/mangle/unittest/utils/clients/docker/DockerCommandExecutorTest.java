...
public class DockerCommandExecutorTest {
    ...
    private String command = "DOCKER_STOP:--containerName fiaascoWEB";
    ...
    @Test
    public void testDockerCommandExecutorInstantiation() {
        DockerCommandExecutor executor = new DockerCommandExecutor(customDockerClient);
    ...
    public void testExecuteCommand() throws MangleException {
        ...
        DockerCommandExecutor executor = spy(new DockerCommandExecutor(customDockerClient));
