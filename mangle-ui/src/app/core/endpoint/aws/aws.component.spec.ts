...
describe('AWSComponent', () => {
  ...
  let ep_data: any = { "id": null, "name": "aws_ep", "endPointType": "AWS", "credentialsName": "aws_cred", "awsConnectionProperties": { "region": "us-west-2" } };
  let ep_data_id: any = { "id": "with_id", "name": "aws_ep", "endPointType": "AWS", "credentialsName": "aws_cred", "awsConnectionProperties": { "hostname": "us-west-2" } };
  let cred_data: any = { "name": "aws_cred", "accessKey": "dasdasd", "secretAccessKey": "dsd/fdf" };
  ...
  it('should get endpoints', () => {
    ...
    expect(component.endpoints[0].name).toBe("aws_ep");
