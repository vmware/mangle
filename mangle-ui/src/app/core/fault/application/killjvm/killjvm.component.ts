...
export class KillJVMComponent extends FaultCommons implements OnInit {

  public supportedEpTypes: any = [CommonConstants.MACHINE, CommonConstants.K8S_CLUSTER, CommonConstants.DOCKER];
  public systemExitCodes: any = ["EX_SIG_KILL", "EX_SIG_QUIT", "EX_SIG_TRAP", "EX_SIG_ABRT",
    "EX_SIG_TERM", "EX_OSERR", "EX_IOERR", "EX_NOHOST"];
