...
@Component({
  selector: "app-threadleak",
  templateUrl: "./threadleak.component.html"
})
export class ThreadLeakComponent extends FaultCommons implements OnInit {
  ...
  public populateFaultData() {
    ...
    this.faultFormData.enableOutOfMemory = this.dataService.sharedData.enableOutOfMemory;
