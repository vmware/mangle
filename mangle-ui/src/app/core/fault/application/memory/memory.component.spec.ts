    ...
    beforeEach(async(() => {
        ...
        TestBed.configureTestingModule({
            imports: [
                ...
                CommonModule,
                ClarityModule,
                RouterTestingModule.withRoutes([{ path: 'memory', component: MemoryComponent }, { path: 'core/requests', component: ProcessedComponent }, { path: 'login', component: LoginComponent }])
            ],
            declarations: [MemoryComponent, CoreComponent, LoginComponent, ProcessedComponent],
            providers: [
                FaultService,
                CoreService,
                RequestsService
