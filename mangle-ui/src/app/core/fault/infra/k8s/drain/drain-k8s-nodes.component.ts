...
@Component({
    selector: "app-drain-k8s-node",
    templateUrl: "./drain-k8s-nodes.component.html"
})
export class DrainK8SNodeComponent extends FaultCommons implements OnInit {
    ...
    public setEndpointVal(endpointName) {
        this.faultFormData.endpointName = endpointName;
        this.getAllNodes(endpointName);
    }
    ...
    public setResourceNameVal(resourceName) {
        this.faultFormData.resourceName = resourceName;
    }
    ...
    public executeK8SDrainNodeFault(faultData) {
        ...
        this.faultService.executeK8SDrainNodeFault(faultData).subscribe(
            res => {
                this.tagsData = {};
