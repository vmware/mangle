...
describe('VcenterStateComponent', () => {
    ...
    beforeEach(() => {
        ...
        spyOn(faultService, 'executeVCenterVMStateFault').and.returnValue(of([component.faultFormData]));
    ...
    it('should execute vcenter state fault', () => {
        ...
        expect(faultService.executeVCenterVMStateFault).toHaveBeenCalled();
    });
