...
describe('VcenterDiskComponent', () => {
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            imports: [
                ...
                CommonModule,
                ClarityModule,
                RouterTestingModule.withRoutes([{ path: 'vcenter-disk', component: VcenterDiskComponent }, { path: 'core/requests', component: ProcessedComponent }, { path: 'login', component: LoginComponent }])
            ],
            declarations: [VcenterDiskComponent, CoreComponent, LoginComponent, ProcessedComponent],
            providers: [
                FaultService,
                CoreService,
                RequestsService
    ...
    beforeEach(() => {
        ...
        spyOn(faultService, 'executeVcenterDiskFault').and.returnValue(of([component.faultFormData]));
    ...
    it('should execute vcenter disk fault', () => {
        ...
        expect(faultService.executeVcenterDiskFault).toHaveBeenCalled();
    });
