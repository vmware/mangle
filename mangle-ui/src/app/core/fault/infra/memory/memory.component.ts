...
@Component({
  selector: "app-memory-infra",
  templateUrl: "./memory.component.html"
})
export class MemoryInfraComponent extends FaultCommons implements OnInit {
  ...
  public populateFaultData() {
    this.faultFormData.memoryLoad = this.dataService.sharedData.memoryLoad;
  ...
  public executeMemoryFault(faultData) {
    ...
    this.faultService.executeMemoryFault(faultData).subscribe(
      res => {
        this.tagsData = {};
