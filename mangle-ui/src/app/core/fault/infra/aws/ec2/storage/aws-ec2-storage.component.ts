...
@Component({
  selector: "app-aws-ec2-storage",
  templateUrl: "./aws-ec2-storage.component.html"
})
export class AwsEC2StorageComponent extends FaultCommons implements OnInit {

  public supportedEpTypes: any = [CommonConstants.AWS];
  public storageFaultTypes: any = ["DETACH_VOLUMES"];
  ...
  public populateFaultData() {
    ...
    this.faultFormData.selectRandomVolumes = this.dataService.sharedData.selectRandomVolumes;
  ...
  public executeAwsEC2StorageFault(faultData) {
    ...
    this.faultService.executeAwsEC2StorageFault(faultData).subscribe(
      res => {
        this.tagsData = {};
