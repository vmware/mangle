...
@Component({
  selector: "app-aws-ec2-state",
  templateUrl: "./aws-ec2-state.component.html"
})
export class AwsEC2StateComponent extends FaultCommons implements OnInit {

  public supportedEpTypes: any = [CommonConstants.AWS];
  public stateFaultTypes: any = ["TERMINATE_INSTANCES", "STOP_INSTANCES", "REBOOT_INSTANCES"];
  ...
  public executeAwsEC2StateFault(faultData) {
    ...
    this.faultService.executeAwsEC2StateFault(faultData).subscribe(
      res => {
        this.tagsData = {};
