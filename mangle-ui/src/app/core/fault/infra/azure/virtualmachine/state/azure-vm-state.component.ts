...
@Component({
  selector: "app-azure-vm-state",
  templateUrl: "./azure-vm-state.component.html"
})
export class AzureVMStateComponent extends FaultCommons implements OnInit {

  public supportedEpTypes: any = [CommonConstants.AZURE];
  public stateFaultTypes: any = ["DELETE_VMS", "STOP_VMS", "RESTART_VMS"];
  ...
  public executeAzureVMStateFault(faultData) {
    ...
    this.faultService.executeAzureVMStateFault(faultData).subscribe(
      res => {
        this.tagsData = {};
