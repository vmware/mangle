...
import { of } from 'rxjs';
import { KillprocessComponent } from './killprocess.component';
...
describe('KillprocessComponent', () => {
    ...
    beforeEach(async(() => {
        ...
        TestBed.configureTestingModule({
            imports: [
                ...
                CommonModule,
                ClarityModule,
                RouterTestingModule.withRoutes([{ path: 'killprocess', component: KillprocessComponent }, { path: 'core/requests', component: ProcessedComponent }, { path: 'login', component: LoginComponent }])
            ],
            declarations: [KillprocessComponent, CoreComponent, LoginComponent, ProcessedComponent],
            providers: [
                FaultService,
                CoreService,
                RequestsService
    ...
    beforeEach(() => {
        ...
        spyOn(faultService, 'executeKillProcessFault').and.returnValue(of([component.faultFormData]));
