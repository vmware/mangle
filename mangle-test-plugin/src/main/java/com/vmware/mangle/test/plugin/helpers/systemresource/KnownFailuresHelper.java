...
public class KnownFailuresHelper {
    ...
    public Map<String, String> getKnownFailuresOfSystemResourceFaultInjectionRequest() {
        ...
        knownFailureMap.put(NETWORK_FAULT_INVALID_NIC_OUTPUT, null);
        ...
        knownFailureMap.put(DISK_SPACE_FILL_PERCENTAGE_GREATER_THAN_USED_DISK_PERCENTAGE_FAILURE_OUTPUT, null);
