...
import com.vmware.mangle.test.plugin.helpers.systemresource.CustomSystemResourceFaultHelper;
...
@Extension(ordinal = 1)
@Log4j2
public class CustomSystemResourceFaultTaskHelper<T extends CommandExecutionFaultSpec>
        extends AbstractRemoteCommandExecutionTaskHelper<T> {

    private CustomSystemResourceFaultHelper systemResourceFaultHelper;
    private ICommandExecutor commandExecutor = null;
    private EndpointClientFactory endpointClientFactory;
    private CustomSystemResourceFaultHelperFactory systemResourceFaultHelperFactory;
    ...
    @Autowired
    public void setSystemResourceFaultUtils(CustomSystemResourceFaultUtils systemResourceFaultUtils) {
        this.systemResourceFaultUtils = systemResourceFaultUtils;
    }

    @Autowired
    public void setSystemResourceFaultHelperFactory(
            CustomSystemResourceFaultHelperFactory systemResourceFaultHelperFactory) {
