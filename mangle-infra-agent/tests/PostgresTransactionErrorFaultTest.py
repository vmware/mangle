...
from Faults.PostgresTransactionErrorFault import PostgresTransactionErrorFault

'''
Unit test cases for PostgresTransactionErrorFault.
@author: kumargautam
'''


class PostgresTransactionErrorFaultTest(TestCase):
    ...
    def setUp(cls):
        ...
        cls.fault_args = {'--operation': 'inject', '--faultname': "pg_transaction_error_fault",
                          ...
                          "--timeout": 1000,
                          "--faultId": "1234"}
        cls.fault = PostgresTransactionErrorFault(cls.fault_args)
