...
java -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/var/opt/mangle-tomcat/logs -Xms512m -Xmx4G $JAVA_OPTS $DB_OPTIONS $CLUSTER_OPTIONS -javaagent:$VAR_OPT/jacocoagent.jar=port=36320,destfile=jacoco-it.exec,output=tcpserver -jar $VAR_OPT/mangle-tomcat/mangle-services.jar