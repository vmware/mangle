...
java -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=/var/opt/mangle-tomcat/logs -Xms512m -Xmx4G $JAVA_OPTS $DB_OPTIONS $CLUSTER_OPTIONS -jar $OPT_DIR/mangle-tomcat/mangle-services.jar